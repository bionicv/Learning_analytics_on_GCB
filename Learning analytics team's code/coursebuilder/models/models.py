...
######### Role: YouTubeEvent Entity to store in the Datastore   ##########################
##########################################################################################  
class YouTubeEvent(BaseEntity):
    user_id = db.StringProperty(indexed=True)
    video = db.StringProperty(indexed=True)
    event = db.StringProperty(indexed=True)
